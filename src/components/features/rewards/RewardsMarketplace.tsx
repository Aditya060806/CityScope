...
export const RewardsMarketplace: React.FC<RewardsMarketplaceProps> = ({
  ...
  if (loading) {
    return (
      <div className={cn('min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50', className)}>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="text-center">
            ...
            {/* Points Display */}
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-8 py-4 text-white">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-4">
            <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3 max-w-2xl mx-auto">
              <TabsTrigger value="catalog" className="flex items-center gap-2 py-3">
                <Gift className="w-5 h-5" />
                <span className="hidden sm:inline">Rewards Catalog</span>
                <span className="sm:hidden">Catalog</span>
              </TabsTrigger>
              <TabsTrigger value="my-rewards" className="flex items-center gap-2 py-3">
                <Trophy className="w-5 h-5" />
                <span className="hidden sm:inline">My Rewards</span>
                <span className="sm:hidden">My Rewards</span>
              </TabsTrigger>
              <TabsTrigger value="partners" className="flex items-center gap-2 py-3">
