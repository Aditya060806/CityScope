-- Update Rewards System for CityScope
-- Remove expensive/commercial rewards and add meaningful civic engagement rewards

-- First, remove the expensive/commercial rewards
...
-- Add meaningful civic engagement rewards
...
-- Recognition & Status Rewards (Low cost, high value)
...
-- Municipal Service Benefits (Feasible for government)
...
('Parking Fee Waiver', 'Free parking for 1 month at municipal lots', 200, 'discount', 0, 'INR', 'Valid at municipal parking lots only.', 500, '/rewards/parking-waiver.png'),
...
-- Community Access & Experiences (Low cost, high engagement)
...
-- Digital & App Benefits (Zero cost, high value)
('Priority Issue Resolution', 'Your reported issues get priority in resolution queue', 200, 'experience', 0, 'INR', 'Valid for next 5 issues. Faster response time guaranteed.', 1000, '/rewards/priority-resolution.png'),
('Advanced Analytics Access', 'Access to detailed city analytics and reports', 300, 'experience', 0, 'INR', '6 months access to premium analytics dashboard.', 200, '/rewards/analytics-access.png'),
('Beta Feature Access', 'Early access to new app features and updates', 150, 'experience', 0, 'INR', 'Test new features before public release.', 500, '/rewards/beta-access.png'),
('Custom Profile Theme', 'Exclusive profile theme and customization options', 100, 'experience', 0, 'INR', 'Unique color scheme and profile layout.', 2000, '/rewards/profile-theme.png'),
('Issue Tracking Dashboard', 'Personal dashboard to track all your reported issues', 250, 'experience', 0, 'INR', 'Advanced tracking with detailed status updates.', 1000, '/rewards/tracking-dashboard.png'),

-- Community Impact Rewards (Meaningful, feasible)
('Tree Plantation Certificate', 'Certificate for sponsoring a tree in your name', 500, 'recognition', 0, 'INR', 'Tree planted in public park with your name plaque.', 100, '/rewards/tree-certificate.png'),
('Community Notice Board Space', 'Display your message on community notice boards', 300, 'experience', 0, 'INR', '1 week display on 5 major community boards.', 200, '/rewards/notice-board.png'),
('Street Naming Suggestion', 'Submit name suggestion for new streets/areas', 400, 'experience', 0, 'INR', 'Your suggestion will be considered by naming committee.', 50, '/rewards/street-naming.png'),
('Community Newsletter Feature', 'Your story featured in monthly community newsletter', 350, 'recognition', 0, 'INR', 'Digital and print newsletter distribution.', 100, '/rewards/newsletter-feature.png'),
('Civic Achievement Trophy', 'Physical trophy for outstanding civic contribution', 600, 'recognition', 0, 'INR', 'Annual award ceremony. Trophy delivered to your address.', 25, '/rewards/achievement-trophy.png'),

-- Educational & Skill Development (Low cost, high value)
('Digital Citizenship Course', 'Free online course on digital citizenship and civic rights', 200, 'experience', 0, 'INR', 'Self-paced course with completion certificate.', 500, '/rewards/digital-citizenship.png'),
('Local History Workshop', 'Workshop on local history and heritage', 150, 'experience', 0, 'INR', '2-hour session with local historian.', 300, '/rewards/history-workshop.png'),
('Civic Rights Seminar', 'Seminar on citizen rights and responsibilities', 180, 'experience', 0, 'INR', 'Half-day seminar with legal experts.', 200, '/rewards/rights-seminar.png'),
('Environmental Awareness Kit', 'Educational kit about local environmental issues', 120, 'experience', 0, 'INR', 'Printed materials and digital resources.', 400, '/rewards/environment-kit.png'),

-- Special Access & Privileges (Feasible for government)
('Municipal Office VIP Pass', 'Skip the queue at municipal offices for 1 month', 300, 'experience', 0, 'INR', 'Priority service at all municipal counters.', 200, '/rewards/vip-pass.png'),
('City Council Meeting Observer', 'Attend city council meeting as observer', 400, 'experience', 0, 'INR', 'One-time access. Must follow meeting protocols.', 100, '/rewards/council-meeting.png'),
('Emergency Services Priority', 'Priority response for non-emergency municipal services', 250, 'experience', 0, 'INR', 'Faster response for maintenance requests.', 300, '/rewards/priority-services.png'),
('Municipal Newsletter Subscription', 'Exclusive monthly newsletter with city updates', 50, 'experience', 0, 'INR', 'Detailed updates on city projects and initiatives.', 2000, '/rewards/newsletter-sub.png'),

-- Social Impact Rewards (Meaningful, community-focused)
('Community Impact Report', 'Detailed report on your civic contributions', 200, 'recognition', 0, 'INR', 'Annual report showing your community impact.', 1000, '/rewards/impact-report.png'),
('Neighborhood Champion Title', 'Official title for your neighborhood', 400, 'recognition', 0, 'INR', 'Recognition as neighborhood civic champion.', 100, '/rewards/neighborhood-champion.png'),
('Civic Engagement Score', 'Personal civic engagement score and ranking', 100, 'recognition', 0, 'INR', 'Monthly score based on your civic activities.', 5000, '/rewards/engagement-score.png'),
('Community Service Hours', 'Official record of community service hours', 150, 'recognition', 0, 'INR', 'Verified hours that can be used for official purposes.', 2000, '/rewards/service-hours.png');

-- Update reward categories to be more appropriate
...
-- Add new reward categories configuration
...
-- Update points earning system to be more generous for civic engagement
INSERT INTO system_settings (key, value, description) VALUES
('points_system', '{
  "issue_reported": 10,
  "issue_verified": 5,
